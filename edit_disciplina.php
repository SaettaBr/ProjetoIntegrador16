<?php
     include 'conecta.php';
     $identEdit=$_GET['cod'];
     $sql="SELECT * FROM disciplina WHERE codigo = '$identEdit'";
...
<br/>   	<div class="container text-center">
		<form name="formCad" id="formCad" class="form-horizontal" action="atualiza_disciplina.php" method="post">
			<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="codigo" name="codigo" type="number" class="form-control input-md" value="<?php echo $linha['codigo']; ?>"placeholder="Digite o código da disciplina" disabled>
                     <input id="codigo" name="codigo" type="hidden" value="<?php echo $linha['codigo']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="nome" name="nome" type="text" value="<?php echo $linha['nome']; ?>"placeholder="Digite o nome da disciplina" class="form-control input-md">
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
                <input id="ch" name="ch" type="number" class="form-control input-md" value="<?php echo $linha['ch']; ?>" placeholder="Digite a carga horária do Curso" class="form-control input-md">
				</div>
			</div> 
