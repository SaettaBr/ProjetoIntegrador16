...
<?php
	...
	if($conexao != null){
		...
		//		echo "<th>$index</th>";
				...
				echo "<td align=center><a id='$identEdit' href='edit_disciplina.php?cod=$identEdit'><i class='glyphicon glyphicon-pencil'></i></a '> | <a id='$identExclud' href='del_disciplina.php?cod=$identExclud'><i class='glyphicon glyphicon-trash'></i></a></td>";
				echo "</tr>";
				echo "<br>";
				$index += 1;
			}
