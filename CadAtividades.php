		...
		if ($projeto != ""){
            if ($disciplina != "") {
                if($descricao != "") {
					...
					echo "<script>window.location='form_cad_atividades.php';alert('Cadastro realizado com sucesso!')</script>";
					} else {
						echo "<script>window.location='form_cad_atividades.php';alert('Já exite uma atividade cadastrada para a disciplina.)</script>";
					}
				}else{
					echo "<script>window.location='form_cad_atividades.php';alert('A descrição não foi informada.')</script>";
				}
			}else{
				echo "<script>window.location='form_cad_atividades.php';alert('A disciplina não foi informada.')</script>";
			}			
        } else {
			echo "<script>window.location='form_cad_atividades.php';alert('O projeto não foi informado.')</script>";
        }
        
    } else {
		echo "<script>window.location='form_cad_atividades.php';alert('Falha na conexão com o banco de dados.')</script>";
    }
