...
//				echo "<th>$index</th>";
				...
				echo "<td align=center><a id='$identEdit' href='edit_usuario.php?log=$identEdit'><i class='glyphicon glyphicon-pencil'></i></a '> | <a id='$identExclud' href='del_usuario.php?log=$identExclud'><i class='glyphicon glyphicon-trash'></i></a></td>";
				echo "</tr>";
				echo "<br>";
				$index += 1;
			}
