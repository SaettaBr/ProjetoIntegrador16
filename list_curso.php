	...
	if($conexao != null){
		...
		if($result != null && $result != false && $rowss > 0){
			...
			//	echo "<tr id='$identTRow'>";
				...
				echo "<a id='$identEdit' href='edit_curso.php?num=$identEdit'><i class='glyphicon glyphicon-pencil'></i></a '> | <a id='$identExclud' href='del_curso.php?num=$identExclud'><i class='glyphicon glyphicon-trash'></i></a>";
				}
				echo "</td>";
				echo "</tr>";
				echo "<br>";
